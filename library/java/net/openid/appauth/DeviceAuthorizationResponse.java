...
public class DeviceAuthorizationResponse {
    ...
    /**
     * The lifetime in seconds of the {@link #deviceCode} and {@link #userCode}.
     *
     * @see "OAuth 2.0 Device Grant (RFC 8628), Section 3.2
     * <https://tools.ietf.org/html/rfc8628#section-3.2>"
     */
    ...
    public static final class Builder {
        ...
        public Builder fromResponseJson(@NonNull JSONObject json) throws JSONException {
            ...
            setVerificationUriComplete(JsonUtil.getStringIfDefined(json, KEY_VERIFICATION_URI_COMPLETE));
            setCodeExpirationTime(json.getLong(KEY_EXPIRES_IN));
        ...
        public Builder setDeviceCode(@Nullable String deviceCode) {
            mDeviceCode = checkNullOrNotEmpty(deviceCode, "device code must not be empty if defined");
            return this;
        }
        ...
        public Builder setVerificationUri(@Nullable String verificationUri) {
            mVerificationUri = checkNullOrNotEmpty(verificationUri, "verification uri must not be empty if defined");
            return this;
        }
        ...
        public Builder setVerificationUriComplete(@Nullable String verificationUriComplete) {
            mVerificationUriComplete = checkNullOrNotEmpty(verificationUriComplete, "complete verification uri must not be empty if defined");
            return this;
        }

        /**
         * Sets the exact expiration time of the code, in milliseconds since the UNIX epoch.
         */
        @NonNull
        public Builder setCodeExpirationTime(@Nullable Long expiresIn) {
            mCodeExpirationTime = expiresIn;
            return this;
        }
     ...
     */
    @NonNull
    public static DeviceAuthorizationResponse jsonDeserialize(@NonNull JSONObject json) throws JSONException {
        if (!json.has(KEY_REQUEST)) {
            throw new IllegalArgumentException(
                    "device authorization request not provided and not found in JSON");
        }
        return new DeviceAuthorizationResponse.Builder(
                DeviceAuthorizationRequest.jsonDeserialize(json.getJSONObject(KEY_REQUEST)))
                .setDeviceCode(JsonUtil.getStringIfDefined(json, KEY_DEVICE_CODE))
                .setUserCode(JsonUtil.getStringIfDefined(json, KEY_USER_CODE))
                .setVerificationUri(JsonUtil.getStringIfDefined(json, KEY_VERIFICATION_URI))
                .setVerificationUriComplete(JsonUtil.getStringIfDefined(json, KEY_VERIFICATION_URI_COMPLETE))
                .setCodeExpirationTime(JsonUtil.getLongIfDefined(json, KEY_EXPIRES_IN))
                .setTokenPollingIntervalTime(JsonUtil.getLongIfDefined(json, KEY_INTERVAL))
     ...
     */
    @NonNull
    public static DeviceAuthorizationResponse jsonDeserialize(@NonNull String jsonStr) throws JSONException {
